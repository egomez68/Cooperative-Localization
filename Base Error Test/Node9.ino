/* 
 *  File        : Node9.ino
 *  Description : Calculate and log 100 instances of node 9's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8428382528; // Known Longitude 
double knownLat =  40.7628551750; // Known Latitude
