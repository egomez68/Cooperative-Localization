/* 
 *  File        : Node8.ino
 *  Description : Calculate and log 100 instances of node 8's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8429966400; // Known Longitude 
double knownLat =  40.7630776000; // Known Latitude
