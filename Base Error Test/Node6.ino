/* 
 *  File        : Node6.ino
 *  Description : Calculate and log 100 instances of node 6's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8431282600; // Known Longitude 
double knownLat =  40.7631133000; // Known Latitude
