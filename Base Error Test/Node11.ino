/* 
 *  File        : Node11.ino
 *  Description : Calculate and log 100 instances of node 11's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8428378972; // Known Longitude 
double knownLat =  40.7630076417; // Known Latitude
