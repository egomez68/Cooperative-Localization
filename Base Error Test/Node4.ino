/* 
 *  File        : baseGpsError_Node4.ino
 *  Description : Calculate and log 100 instances of node 4's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8429317700; // Known Longitude 
double knownLat =  40.7633224700; // Known Latitude
