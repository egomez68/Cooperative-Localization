/* 
 *  File        : Node15.ino
 *  Description : Calculate and log 100 instances of node 15's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8427048889; // Known Longitude 
double knownLat =  40.7631442861; // Known Latitude
