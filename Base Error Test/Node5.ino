/* 
 *  File        : Node5.ino
 *  Description : Calculate and log 100 instances of node 5's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8432279800; // Known Longitude 
double knownLat =  40.7631144000; // Known Latitude
