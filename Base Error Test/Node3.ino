/* 
 *  File        : Node3.ino
 *  Description : Calculate and log 100 instances of node 3's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8428804400; // Known Longitude 
double knownLat =  40.7632478400; // Known Latitude
