/* 
 *  File        : Node14.ino
 *  Description : Calculate and log 100 instances of node 14's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8426026694; // Known Longitude 
double knownLat =  40.7631415806; // Known Latitude
