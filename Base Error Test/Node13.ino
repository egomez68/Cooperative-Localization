/* 
 *  File        : Node13.ino
 *  Description : Calculate and log 100 instances of node 13's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8425023861; // Known Longitude 
double knownLat =  40.7631394722; // Known Latitude
