/* 
 *  File        : Node7.ino
 *  Description : Calculate and log 100 instances of node 7's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8430280300; // Known Longitude 
double knownLat =  40.7631126600; // Known Latitude
