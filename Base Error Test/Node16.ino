/* 
 *  File        : Node16.ino
 *  Description : Calculate and log 100 instances of node 16's base gps error.
 *  Author      : Edgar Gomez 
 */
...
double knownLng = -83.8427340472; // Known Longitude 
double knownLat =  40.7631836722; // Known Latitude
